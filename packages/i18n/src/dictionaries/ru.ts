...
export const ru: Dictionary = {
  ...
  'buffer.title': 'Буфер',
  'buffer.hint':
    'Неразмещённые стопки. Перетащите стопку в кузов, чтобы поставить — или вытащите стопку из кузова сюда, чтобы освободить место (например, для поворота).',
  'buffer.count': '{n} не размещено',
  'buffer.empty': 'Всё размещено — буфер пуст.',
  'buffer.rotate': 'Повернуть стопку в буфере',
  'buffer.dropHint': 'Перетащите в кузов, чтобы поставить',
