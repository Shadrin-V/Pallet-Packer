...
export const ru: Dictionary = {
  ...
  ERR_INVALID_COMPARTMENTS:
    'Отсеки кузова заданы некорректно: длины должны быть целыми положительными числами, координаты — целыми числами от 0, по возрастанию и без пересечений (разрыв между ними, например сцепка автопоезда, допустим), а конец последнего отсека — совпадать с концом транспорта.',
