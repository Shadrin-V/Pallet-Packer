...
//
// Асимметрия: исключение aria-hidden действует только на текстовые узлы (JSXText).
// Атрибуты из TEXT_PROPS проверяются всегда, потому что aria-hidden прячет узел от скринридера,
