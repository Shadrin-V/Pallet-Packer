> ▶ Есть более свежий handover: `HANDOVER-2026-07-24-dwc-tail.md` (dwc.11 + dwc.10 закрыты, #27). Этот — по dwc.7-9.
...
- Эпик `LKWkalk-dwc`: на момент этой сессии 8/11 (закрыты `dwc.1–4,6–9`). **Обновление 2026-07-24: 10/11** —
  `dwc.10`/`dwc.11` закрыты (#27, см. `HANDOVER-2026-07-24-dwc-tail.md`); открыт только `dwc.5`.
...
2. **Хвост эпика `dwc`:** `dwc.10`/`dwc.11` закрыты 2026-07-24 (#27). Открыт только `dwc.5` (клавиатурный
   доступ к постановке стопки) — a11y-фича, требует brainstorming.
